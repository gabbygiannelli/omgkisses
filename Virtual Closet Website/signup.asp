...
<!--Content-->
<section style="margin-top: 56px; background: #b2dede;">
  <div class="container">
    <form class="form-signup">
      <h3 class="form-signup-heading">Please complete the form below to sign up</h3>
      ...
      <div class="row">
        <div class="col-sm-6">
          <p>Already registered? <a href="login.asp" target="_self" class="btn btn-sm btn-primary">Sign In</a></p>
        </div><!-- /end col -->  
        <div class="col-sm-6">
